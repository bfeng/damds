...
public class DAMDSSection {
    ...
    public DAMDSSection(String configurationFilePath) {
        ...
        try {
            ...
            sparseScoreIndexFile = getProperty(p, "SparseScoreMatrixIndices", "");
            sparseScoreDataFile = getProperty(p, "SparseScoreMatrixData", "");
    ...
    public String sparseScoreIndexFile;
    public String sparseScoreDataFile;
